...
symmetrisation. It is, however, still far from perfect:
...
Symmetrised ideal (Chatzopoulos)        & $0.634$ \\
Single optimised material ($1\times1$, 4CM)                 & $0.857$ \\
\midrule
Ideal continuous $\mbf{c}_{\mathrm{eff}}$ (polar) & $0.999$ \\
\bottomrule
\end{tabular*}
\end{table}
