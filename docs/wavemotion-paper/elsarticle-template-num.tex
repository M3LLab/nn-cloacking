...
microstructure descriptor, extending its validity towards the shorter
wavelengths where finite-wavelength corrections to the quasi-static
homogenised response grow. A third extension is to move from the
