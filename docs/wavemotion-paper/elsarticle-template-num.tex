...
We report three diagnostic metrics. Two are relative $L^2$
distortions. The \emph{right-boundary distortion}
...
$\eta\to1$ for a perfect cloak. These three quantities are diagnostics,
\emph{not} the training objective: optimisation minimises the
phase-invariant magnitude-band integral~\eqref{eq:opt_loss_cloak}, and
the microstructure-constrained pipeline inherits the same objective.
