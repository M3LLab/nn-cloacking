...
\begin{frame}{ML methods for realisable symmetric cloaks}
  ...
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.49\textwidth}
      \begin{block}{ML challenges}
        \begin{itemize}\footnotesize
          \item The set of \textbf{realisable materials is discrete}.
          \item \textbf{Validation is prohibitively expensive}.
        \end{itemize}
      \end{block}
      \vspace{0.2em}
      % \takeaway{This is why we use a \textbf{two-stage} approach.}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Neural field}
  \begin{columns}[T]
    \begin{column}{0.66\textwidth}
      ...
      \begin{tikzpicture}
        \node[inner sep=0,anchor=south west] (tb) at (0,0)
          {\includegraphics[width=\linewidth]{figures/triangle-bottom.jpg}};
        \draw[red,line width=1.2pt]
          (tb.south west) -- ([xshift=0.47\linewidth]tb.north west);
